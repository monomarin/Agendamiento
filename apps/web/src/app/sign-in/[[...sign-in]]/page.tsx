      ...
      <div className="hidden lg:flex lg:col-span-7 relative flex-col justify-between p-12 overflow-hidden bg-neutral-900 border-r border-neutral-800">
        ...
        <div className="relative z-10 max-w-lg space-y-6">
          <h1 className="text-4xl xl:text-5xl font-bold tracking-tight leading-tight">
            Gestiona tus reservas con el poder de la <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-amber-500">IA</span>.
          </h1>
          <p className="text-neutral-400 text-lg leading-relaxed">
            Optimiza la disponibilidad de tus mesas, automatiza la confirmación de clientes por WhatsApp y obtén analíticas avanzadas en una sola plataforma.
          </p>

          <div className="pt-4 flex gap-4">
            <div className="flex-1 p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md">
              <h3 className="font-semibold text-white">Guest-First</h3>
              <p className="text-sm text-neutral-400 mt-1">Reservas fluidas sin registro obligatorio.</p>
            </div>
            <div className="flex-1 p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md">
              <h3 className="font-semibold text-white">Cal.com Engine</h3>
              <p className="text-sm text-neutral-400 mt-1">Sincronización robusta en tiempo real.</p>
            </div>
          </div>
        </div>
